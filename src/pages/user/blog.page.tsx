...
function BlogPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-muted/30 border-b border-border py-2 mt-20">
        <div className="max-w-[1200px] mx-auto px-4 flex items-center gap-2 text-[10px] font-bold text-muted-foreground uppercase tracking-widest">
      ...
      <div className="bg-secondary/50 dark:bg-secondary/20 py-10 mt-20 border-t border-border">
