...
import LeftSidebar from "@/sections/user/QA/left-sidebar/left-sidebar.section";
import RightSidebar from "@/sections/user/QA/right-sidebar/right-sidebar.section";
